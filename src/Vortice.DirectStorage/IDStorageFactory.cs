...
public partial class IDStorageFactory
{
...
#endif
    T>(QueueDesc description, out T? queue) where T : ComObject
    {
    ...
    public T CreateQueue<
        ...
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
    T>(QueueDesc description) where T : ComObject
    {
    ...
    public Result OpenFile<
        ...
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
    T>(string path, out T? file) where T : ComObject
    {
    ...
    public T OpenFile<
        ...
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
    T>(string path) where T : ComObject
    {
    ...
    public Result CreateStatusArray<
#if NET6_0_OR_GREATER
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
    T>(uint capacity, string name, out T? statusArray) where T : ComObject
    {
    ...
    public T CreateStatusArray<
#if NET6_0_OR_GREATER
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
    T>(uint capacity, string name) where T : ComObject
    {
