...
public partial class IDirect3DDevice9On12
{
    ...
    public T UnwrapUnderlyingResource<
        ...
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
    T>(IDirect3DResource9 resource, ComObject commandQueue) where T : ComObject
    {
    ...
    public Result UnwrapUnderlyingResource<
        ...
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
    T>(IDirect3DResource9 resource, ComObject commandQueue, out T? resource12) where T : ComObject
    {
