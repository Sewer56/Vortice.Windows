...
public partial class DXGI
{
    ...
    public static Result CreateDXGIFactory1<
#if NET6_0_OR_GREATER
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
        T>(out T? factory) where T : IDXGIFactory1
    {
    ...
    public static T CreateDXGIFactory1<
#if NET6_0_OR_GREATER
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
    T>() where T : IDXGIFactory1
    {
    ...
    /// <returns>Return the <see cref="Result"/>.</returns>
    public static Result CreateDXGIFactory2<
#if NET6_0_OR_GREATER
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
    T>(bool debug, out T? factory) where T : IDXGIFactory2
    {
    ...
    public static T CreateDXGIFactory2<
#if NET6_0_OR_GREATER
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
    T>(bool debug) where T : IDXGIFactory2
    {
        int flags = debug ? CreateFactoryDebug : 0x00;
    ...
    public static Result DXGIGetDebugInterface1<
#if NET6_0_OR_GREATER
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
    ...
    public static T DXGIGetDebugInterface1<
#if NET6_0_OR_GREATER
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
#endif
    T>() where T : ComObject
